...
export async function POST(req: NextRequest) {
  ...
  // Minta token dari Cloudflare Worker
  ...
  await resend.emails.send({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px;">
        <h2 style="color:#1a1a1a;margin-bottom:8px;">Masuk ke ShortLink</h2>
        <p style="color:#555;margin-bottom:24px;">
          Klik tombol di bawah untuk login. Link berlaku selama <strong>15 menit</strong>.
        </p>
        <a href="${magicLink}"
