      ...
      <main className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          {[
            ...
            { label: 'Total klik', value: totalClicks.toLocaleString('id') },
            { label: 'Link aktif', value: links.length },
          ].map(s => (
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 mb-6">
          ...
          <form onSubmit={handleCreate} className="space-y-3">
            <input
              ...
              placeholder="https://url-panjang-kamu.com/path/yang/panjang"
              required
              className="w-full px-3 py-2.5 rounded-lg border border-gray-300
                         focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
            />
            <div className="flex gap-3">
              <div className="flex items-center flex-1 gap-2 px-3 py-2.5 rounded-lg
                              border border-gray-300 focus-within:ring-2 focus-within:ring-blue-500">
              ...
              <button
                ...
                className="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 disabled:opacity-50
                           text-white font-medium rounded-lg text-sm transition-colors whitespace-nowrap"
              >
            ...
            <p className="text-xs text-gray-400">
              Kosongkan slug untuk generate otomatis. Slug hanya boleh huruf kecil, angka, - dan _.
            </p>
          </form>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            <h2 className="font-medium text-gray-900">
              {user?.role === 'user' ? 'Link kamu' : 'Semua link'}
            </h2>
          ...
          {links.length === 0 ? (
            <div className="py-12 text-center text-gray-400">
              ...
              <p className="text-sm">Belum ada link. Buat yang pertama!</p>
            </div>
          ) : (
            <div className="divide-y divide-gray-100">
              {links.map(link => (
                <div key={link.id}
                  ...
                  {/* Slug badge */}
                  <code className="bg-blue-50 text-blue-700 text-xs px-2 py-1 rounded-md
                  ...
                  {/* Klik */}
                  <span className="text-xs text-gray-400 whitespace-nowrap">
                    {link.click_count.toLocaleString('id')} klik
                  </span>
